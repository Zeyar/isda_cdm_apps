...
public class Validation {
	...
	public static void main(String[] args) {
		...
		//
		List<Validator> validators = newArrayList(concat(fixedRatePayoutMeta.choiceRuleValidators(), fixedRatePayoutMeta.dataRules()));
		...
		//
		Object validationResult = new InterestRatePayoutActualQuantityDataRule()
